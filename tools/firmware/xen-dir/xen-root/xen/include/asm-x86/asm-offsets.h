...
#define VCPU_cr3 3024 /* offsetof(struct vcpu, arch.cr3) */
#define VCPU_arch_msrs 3224 /* offsetof(struct vcpu, arch.msrs) */
...
#define DOMAIN_is_32bit_pv 1824 /* offsetof(struct domain, arch.is_32bit_pv) */
...
#define DOMAIN_vm_assist 472 /* offsetof(struct domain, vm_assist) */
