...
static inline void _nocheck__trace_run_poll_handlers_begin(void * ctx, int64_t max_ns)
{
    if (trace_event_get_state(TRACE_RUN_POLL_HANDLERS_BEGIN) && qemu_loglevel_mask(LOG_TRACE)) {
        ...
        qemu_log("%d@%zu.%06zu:run_poll_handlers_begin " "ctx %p max_ns %"PRId64 "\n",
                 getpid(),
...
static inline void _nocheck__trace_run_poll_handlers_end(void * ctx, bool progress)
{
    if (trace_event_get_state(TRACE_RUN_POLL_HANDLERS_END) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:run_poll_handlers_end " "ctx %p progress %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , ctx, progress);
    }
...
{
    if (trace_event_get_state(TRACE_QEMU_CO_QUEUE_RUN_RESTART) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:qemu_co_queue_run_restart " "co %p" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , co);
    }
...
{
    if (trace_event_get_state(TRACE_QEMU_VFIO_DMA_MAP_INVALID) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:qemu_vfio_dma_map_invalid " "s %p mapping %p %zu requested %p %zu" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
