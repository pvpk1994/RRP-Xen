...
{
    if (trace_event_get_state(TRACE_XICS_ICS_SIMPLE_SET_IRQ_MSI) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:xics_ics_simple_set_irq_msi " "set_irq_msi: srcno %d [irq 0x%x]" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , srcno, nr);
    }
...
{
    if (trace_event_get_state(TRACE_XICS_ICS_SIMPLE_SET_IRQ_LSI) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:xics_ics_simple_set_irq_lsi " "set_irq_lsi: srcno %d [irq 0x%x]" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , srcno, nr);
    }
...
{
    if (trace_event_get_state(TRACE_XICS_ICS_SIMPLE_WRITE_XIVE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:xics_ics_simple_write_xive " "ics_write_xive: irq 0x%x [src %d] server 0x%x prio 0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
{
    if (trace_event_get_state(TRACE_XICS_ICS_SIMPLE_REJECT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:xics_ics_simple_reject " "reject irq 0x%x [src %d]" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , nr, srcno);
    }
...
{
    if (trace_event_get_state(TRACE_XICS_ICS_SIMPLE_EOI) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:xics_ics_simple_eoi " "ics_eoi: irq 0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , nr);
    }
...
{
    if (trace_event_get_state(TRACE_FLIC_NO_DEVICE_API) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:flic_no_device_api " "flic: no Device Contral API support %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , err);
    }
...
static inline void _nocheck__trace_gic_update_bestirq(int cpu, int irq, int prio, int priority_mask, int running_priority)
{
    if (trace_event_get_state(TRACE_GIC_UPDATE_BESTIRQ) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:gic_update_bestirq " "cpu %d irq %d priority %d cpu priority mask %d cpu running priority %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_gic_acknowledge_irq(int cpu, int irq)
{
    if (trace_event_get_state(TRACE_GIC_ACKNOWLEDGE_IRQ) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:gic_acknowledge_irq " "cpu %d acknowledged irq %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , cpu, irq);
    }
...
{
    if (trace_event_get_state(TRACE_NVIC_SET_PENDING_LEVEL) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:nvic_set_pending_level " "NVIC set pending: irq %d higher prio than vectpending: setting irq line to 1" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , irq);
    }
