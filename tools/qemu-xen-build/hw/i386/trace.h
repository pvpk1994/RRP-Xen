...
{
    if (trace_event_get_state(TRACE_VTD_INV_DESC_INVALID) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_inv_desc_invalid " "invalid inv desc hi 0x%"PRIx64" lo 0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , hi, lo);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_INV_DESC_CC_INVALID) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_inv_desc_cc_invalid " "invalid context-cache desc hi 0x%"PRIx64" lo 0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , hi, lo);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_INV_DESC_IOTLB_INVALID) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_inv_desc_iotlb_invalid " "invalid iotlb desc hi 0x%"PRIx64" lo 0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , hi, lo);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_INV_DESC_WAIT_INVALID) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_inv_desc_wait_invalid " "invalid wait desc hi 0x%"PRIx64" lo 0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , hi, lo);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_RE_INVALID) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_re_invalid " "invalid root entry hi 0x%"PRIx64" lo 0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , hi, lo);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_CE_INVALID) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_ce_invalid " "invalid context entry hi 0x%"PRIx64" lo 0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , hi, lo);
    }
...
static inline void _nocheck__trace_vtd_replay_ce_valid(uint8_t bus, uint8_t dev, uint8_t fn, uint16_t domain, uint64_t hi, uint64_t lo)
{
    if (trace_event_get_state(TRACE_VTD_REPLAY_CE_VALID) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_replay_ce_valid " "replay valid context device %02"PRIx8":%02"PRIx8".%02"PRIx8" domain 0x%"PRIx16" hi 0x%"PRIx64" lo 0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_vtd_reg_dmar_root(uint64_t addr, bool extended)
{
    if (trace_event_get_state(TRACE_VTD_REG_DMAR_ROOT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_reg_dmar_root " "addr 0x%"PRIx64" extended %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , addr, extended);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_ERR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_err " "%s" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , str);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_ERR_DMAR_IOVA_OVERFLOW) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_err_dmar_iova_overflow " "iova 0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , iova);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_ERR_DMAR_SLPTE_READ_ERROR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_err_dmar_slpte_read_error " "iova 0x%"PRIx64" level %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , iova, level);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_ERR_DMAR_SLPTE_PERM_ERROR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_err_dmar_slpte_perm_error " "iova 0x%"PRIx64" level %d slpte 0x%"PRIx64" write %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
{
    if (trace_event_get_state(TRACE_VTD_ERR_DMAR_SLPTE_RESV_ERROR) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_err_dmar_slpte_resv_error " "iova 0x%"PRIx64" level %d slpte 0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , iova, level, slpte);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_ERR_DMAR_TRANSLATE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_err_dmar_translate " "dev %02x:%02x.%02x iova 0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , bus, slot, func, iova);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_ERR_QI_DISABLE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_err_qi_disable " "head 0x%"PRIx16" tail 0x%"PRIx16" last_desc_type %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , head, tail, type);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_ERR_QI_TAIL) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_err_qi_tail " "tail 0x%"PRIx16" size 0x%"PRIx16 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , tail, size);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_ERR_IRTE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_err_irte " "index %d low 0x%"PRIx64" high 0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , index, lo, hi);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_ERR_IRTE_SID) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_err_irte_sid " "index %d SVT_ALL sid 0x%"PRIx16" (should be: 0x%"PRIx16")" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , index, req, target);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_ERR_IRTE_SID_BUS) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_err_irte_sid_bus " "index %d SVT_BUS bus 0x%"PRIx8" (should be: 0x%"PRIx8"-0x%"PRIx8")" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , index, bus, min, max);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_ERR_IRTE_SVT) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_err_irte_svt " "index %d SVT type %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , index, type);
    }
...
{
    if (trace_event_get_state(TRACE_VTD_ERR_IR_MSI_INVALID) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vtd_err_ir_msi_invalid " "sid 0x%"PRIx16" addr 0x%"PRIx64" data 0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , sid, addr, data);
    }
