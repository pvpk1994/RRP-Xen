...
{
    if (trace_event_get_state(TRACE_PCNET_MMIO_WRITEB) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pcnet_mmio_writeb " "opaque=%p addr=0x%"PRIx64" val=0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , opaque, addr, val);
    }
...
{
    if (trace_event_get_state(TRACE_PCNET_MMIO_WRITEW) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pcnet_mmio_writew " "opaque=%p addr=0x%"PRIx64" val=0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , opaque, addr, val);
    }
...
{
    if (trace_event_get_state(TRACE_PCNET_MMIO_WRITEL) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pcnet_mmio_writel " "opaque=%p addr=0x%"PRIx64" val=0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , opaque, addr, val);
    }
...
{
    if (trace_event_get_state(TRACE_PCNET_MMIO_READB) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pcnet_mmio_readb " "opaque=%p addr=0x%"PRIx64" val=0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , opaque, addr, val);
    }
...
{
    if (trace_event_get_state(TRACE_PCNET_MMIO_READW) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pcnet_mmio_readw " "opaque=%p addr=0x%"PRIx64" val=0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , opaque, addr, val);
    }
...
{
    if (trace_event_get_state(TRACE_PCNET_MMIO_READL) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:pcnet_mmio_readl " "opaque=%p addr=0x%"PRIx64" val=0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , opaque, addr, val);
    }
