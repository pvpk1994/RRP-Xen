...
#define TRACE_VFIO_MSIX_RELO_COST_BACKEND_DSTATE() ( \
    trace_event_get_state_dynamic_by_id(TRACE_VFIO_MSIX_RELO_COST) || \
    false)

static inline void _nocheck__trace_vfio_msix_relo_cost(const char * name, int bar, uint64_t cost)
{
    if (trace_event_get_state(TRACE_VFIO_MSIX_RELO_COST) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vfio_msix_relo_cost " " (%s) BAR %d cost 0x%"PRIx64"" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , name, bar, cost);
    }
...
static inline void _nocheck__trace_vfio_populate_device_get_irq_info_failure(void)
{
    if (trace_event_get_state(TRACE_VFIO_POPULATE_DEVICE_GET_IRQ_INFO_FAILURE) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vfio_populate_device_get_irq_info_failure " "VFIO_DEVICE_GET_IRQ_INFO failure: %m" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 );
    }
...
static inline void _nocheck__trace_vfio_spapr_create_window(int ps, uint64_t ws, uint64_t off)
{
    if (trace_event_get_state(TRACE_VFIO_SPAPR_CREATE_WINDOW) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vfio_spapr_create_window " "pageshift=0x%x winsize=0x%"PRIx64" offset=0x%"PRIx64 "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , ps, ws, off);
    }
