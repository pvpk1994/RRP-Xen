...
static inline void _nocheck__trace_vm_state_notify(int running, int reason)
{
    if (trace_event_get_state(TRACE_VM_STATE_NOTIFY) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:vm_state_notify " "running %d reason %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , running, reason);
    }
...
static inline void _nocheck__trace_runstate_set(int new_state)
{
    if (trace_event_get_state(TRACE_RUNSTATE_SET) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:runstate_set " "new state %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , new_state);
    }
...
static inline void _nocheck__trace_job_completed(void * job, int ret, int jret)
{
    if (trace_event_get_state(TRACE_JOB_COMPLETED) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:job_completed " "job %p ret %d corrected ret %d" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , job, ret, jret);
    }
...
static inline void trace_job_completed(void * job, int ret, int jret)
{
    if (true) {
        _nocheck__trace_job_completed(job, ret, jret);
    }
}
