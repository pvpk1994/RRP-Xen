...
static inline void _nocheck__trace_get_queued_page_not_dirty(const char * block_name, uint64_t tmp_offset, unsigned long page_abs, int sent)
{
    if (trace_event_get_state(TRACE_GET_QUEUED_PAGE_NOT_DIRTY) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:get_queued_page_not_dirty " "%s/0x%" PRIx64 " page_abs=0x%lx (sent=%d)" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
...
static inline void _nocheck__trace_multifd_recv(uint8_t id, uint64_t packet_num, uint32_t used, uint32_t flags)
{
    if (trace_event_get_state(TRACE_MULTIFD_RECV) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:multifd_recv " "channel %d packet number %" PRIu64 " pages %d flags 0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , id, packet_num, used, flags);
    }
}

static inline void trace_multifd_recv(uint8_t id, uint64_t packet_num, uint32_t used, uint32_t flags)
{
    if (true) {
        _nocheck__trace_multifd_recv(id, packet_num, used, flags);
    }
}
...
static inline void _nocheck__trace_multifd_send(uint8_t id, uint64_t packet_num, uint32_t used, uint32_t flags)
{
    if (trace_event_get_state(TRACE_MULTIFD_SEND) && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
        qemu_log("%d@%zu.%06zu:multifd_send " "channel %d packet_num %" PRIu64 " pages %d flags 0x%x" "\n",
                 getpid(),
                 (size_t)_now.tv_sec, (size_t)_now.tv_usec
                 , id, packet_num, used, flags);
    }
...
static inline void trace_multifd_send(uint8_t id, uint64_t packet_num, uint32_t used, uint32_t flags)
{
    if (true) {
        _nocheck__trace_multifd_send(id, packet_num, used, flags);
    }
}
